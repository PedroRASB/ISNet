...
class IsVGG19Lightning(pl.LightningModule):
    def __init__(self,multiLabel,multiMask,
                 classes,
                 e=10e-2,heat=True,
                 Zb=True,pretrained=False,
                 ...
                 cut=1,cut2=25,alternativeCut=False,detachNorm=False,var=False,
                 eps=1e-10,momentum=0.99):
        #Creates ISNet based on VGG19, non instantiated
        ...
        super (IsVGG19Lightning,self).__init__()
        self.save_hyperparameters()
        
        import torchvision
        self.VGG=torchvision.models.vgg19(pretrained=pretrained,num_classes=classes)
        
        self.LRPBlock=ISNetLayers._LRPVGG(self.VGG,e=e,Zb=Zb)
        self.heat=heat
        self.lr=LR
        self.P=P
        self.E=E
