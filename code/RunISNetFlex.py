...
import ISNetFlexLightning as ISNetLightning
...
def main(hparams):
    ...
    trainSet=MNISTDatset('train',masks=True,bias=bias)
    testSet=MNISTDatset('test',masks=True,bias=bias)
    valSet=MNISTDatset('val',masks=True,bias=bias)
    ...
    if(hparams.train=='1' and (hparams.cut=='tune') and (hparams.continuing=='0')): 
        ...
        net=ISNetLightning.ISNetFlexLgt(architecture=hparams.backbone,
                                       ...
                                       HiddenLayerPenalization=(hparams.penalizeAll=='1'),
    ...
    if(hparams.train=='1'):
        ...
        if checkpoint is not None:
            del net
            net=ISNetLightning.ISNetFlexLgt.load_from_checkpoint(checkpoint)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--selectiveEps', default='0.01')
